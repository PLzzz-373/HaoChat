...
import com.gugugu.haochat.chat.domain.dto.RoomBaseInfo;
import com.gugugu.haochat.chat.domain.entity.*;
import com.gugugu.haochat.chat.domain.enums.GroupRoleAPPEnum;
...
import com.gugugu.haochat.chat.service.cache.*;
...
public class RoomAppServiceImpl implements RoomAppService {
    ...
    @Override
    public CursorPageBaseResp<ChatRoomResp> getContactPage(CursorPageBaseReq req, Long uid) {
        //查出用户要展示的会话列表
