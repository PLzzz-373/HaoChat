...
import static com.gugugu.haochat.websocket.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.gugugu.haochat.websocket.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
