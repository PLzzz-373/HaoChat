...
import com.gugugu.haochat.user.domain.enums.ApplyReadStatusEnum;
import com.gugugu.haochat.user.domain.enums.ApplyStatusEnum;
import com.gugugu.haochat.user.domain.enums.ApplyTypeEnum;
