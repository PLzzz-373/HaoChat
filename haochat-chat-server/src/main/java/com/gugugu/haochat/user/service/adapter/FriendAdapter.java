...
import static com.gugugu.haochat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.gugugu.haochat.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
import static com.gugugu.haochat.user.domain.enums.ApplyTypeEnum.ADD_FRIEND;
